  ...
  e.fn.gaugeMeter = function (t) {
    ...
    return this.each(function () {
      ...
      var b = e("<canvas></canvas>").attr({width: l.size, height: l.size}).appendTo(e(this)).get(0),
        ...
        x = (_ * (Math.PI / 180), b.width / 2.5), k = 2.3 * Math.PI, G = 0, M = 0 === l.animationstep ? c : 0,
        z = Math.max(l.size, 0), P = 2 * Math.PI, I = Math.PI / 2, R = "";
      if (void 0 != e(this).data("style")) {
        if (R = e(this).data("style"), "Semi" == R) var k = 2 * Math.PI, G = 3.13, P = 1 * Math.PI, I = Math.PI / .996;
